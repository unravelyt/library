...
- 登录
- 编辑个人信息
- 搜索书籍，按书名关键字搜索，按类别查询，按ISBN号
- 借书，还书，续借
- 查看个人借书信息，借书日期，还书日期，尚未归还书籍
...
create table books(
	...
	rest_number		int(10)			default	null,
	primary key (id),
	constraint book_class_fk foreign key (class_id) references classes(id)
);
...
insert into admin values(1,"admin1","1234","管理员1","女","13400001111");
insert into admin values(2,"admin2","1234","管理员2","男","13455557777");
...
insert into reader values(1, "zhangsan","1234","张三","男",null,null,null,0);
insert into reader values(2, "lisi","1234","李四","男",null,null,null,0);
...
create table record(
	...
	primary key (id),
	-- constraint lend_reader_fk foreign key (reader_id) references reader(id),
	-- constraint lend_book_fk foreign key (book_id) references books(id)
);
